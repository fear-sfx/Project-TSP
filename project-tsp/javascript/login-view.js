function LoginView(context2D, baseModel, x, y, width, height, isEnabled) {
   ...
   CocoonJS.App.onTextDialogCancelled.addEventListener(
	...
	self.addChildren([usernameButton, passwordButton]);
	...
	var chooseCharacterButtonY = self.y + (self.height - chooseCharacterButtonHeight) / 2 + chooseCharacterButtonHeight / 3;
