...
function Glue() { 
	...
	this.addEventListener("keydown", function(event) {
		switch(event.keyCode) {
			...
			case 38 : this.mainView.onUpStarted(); break;
			case 39 : this.mainView.onRightStarted(); break;
			case 40 : this.mainView.onDownStarted(); break;		
		}
			/*if(event.keyCode == 37) {
	...
	this.addEventListener("keyup", function(event) {
		switch(event.keyCode) {
			case 37 : this.mainView.onLeftEnded(); break;
			case 38 : this.mainView.onUpEnded(); break;
			case 39 : this.mainView.onRightEnded(); break;
			case 40 : this.mainView.onDownEnded(); break;		
		}		
			/*if(event.keyCode == 37) {
