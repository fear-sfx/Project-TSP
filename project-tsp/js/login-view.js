function LoginView(context2D, baseModel, x, y, width, height, isEnabled, level) {
	...
	var showEnterUsername = function() {
		...
		CocoonJS.App.showTextDialog( "Username", "Please Enter Your Username", usernameButton.getLabel(), CocoonJS.App.KeyboardType.TEXT, "Cancel", "Ok" );
	}
...
// New Code starts from here:	
	...
	var serverButtonLabel = "188.254.195.75";
...
//New Code Ends here.
   ...
   CocoonJS.App.onTextDialogCancelled.addEventListener(
	...
	loginButton.addCallback('onClick', function(point, object) {
		if (self.onLogin) {
			self.onLogin(usernameButton.getLabel(), passwordButton.getLabel(), serverButton.getLabel());
		}
	});
